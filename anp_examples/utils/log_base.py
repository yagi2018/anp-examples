...
def get_project_name():
    ...
    project_dir = os.path.basename(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    return project_dir
...
def setup_logging(level=logging.INFO):
    ...
    if os.uname().sysname == 'Darwin':  # macOS
        log_file = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), f'{project_name}.log')
    else:
